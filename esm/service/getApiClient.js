...
export const setApiClientId = (clientId, forServer = null) => {
    global.wazoClientId[String(forServer)] = clientId;
};
export const setCurrentServer = (newServer) => {
    global.wazoCurrentServer = newServer;
};
export const setApiToken = (newToken, forServer = null) => {
    global.wazoClientToken[String(forServer)] = newToken;
};
export const setRefreshToken = (newRefreshToken, forServer = null) => {
    global.wazoRefreshToken[String(forServer)] = newRefreshToken;
};
export const setRefreshTenantId = (refreshTenantId, forServer = null) => {
...
export const setRefreshDomainName = (refreshDomainName, forServer = null) => {
    global.wazoRefreshDomainName[String(forServer)] = refreshDomainName;
};
export const setOnRefreshToken = (onRefreshToken, forServer = null) => {
    global.wazoOnRefreshToken[String(forServer)] = onRefreshToken;
};
export const setOnRefreshTokenError = (callback, forServer = null) => {
    global.wazoOnRefreshTokenError[String(forServer)] = callback;
};
export const setRefreshExpiration = (refreshExpiration, forServer = null) => {
    global.wazoRefreshExpiration[String(forServer)] = refreshExpiration;
};
export const setRefreshBackend = (refreshBackend, forServer = null) => {
    global.wazoRefreshBackend[String(forServer)] = refreshBackend;
};
export const setIsMobile = (isMobile, forServer = null) => {
    global.wazoIsMobile[String(forServer)] = isMobile;
};
export const setFetchOptions = (fetchOptions, forServer = null) => {
