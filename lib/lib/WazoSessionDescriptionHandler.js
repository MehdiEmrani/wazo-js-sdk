...
exports.wazoMediaStreamFactory = void 0;
/* global RTCSessionDescriptionInit, navigator */
const events_1 = __importDefault(require("events"));
const session_description_handler_1 = require("sip.js/lib/platform/web/session-description-handler/session-description-handler");
const IssueReporter_1 = __importDefault(require("../service/IssueReporter"));
const sdp_1 = require("../utils/sdp");
const wazoLogger = IssueReporter_1.default ? IssueReporter_1.default.loggerFor('webrtc-sdh') : console;
...
class WazoSessionDescriptionHandler extends session_description_handler_1.SessionDescriptionHandler {
    ...
    getDescription(options = {}, modifiers) {
        ...
        const iceTimeout = options.iceGatheringTimeout === undefined ? (_a = this.sessionDescriptionHandlerConfiguration) === null || _a === void 0 ? void 0 : _a.iceGatheringTimeout : options.iceGatheringTimeout;
        ...
        this.peerConnectionDelegate.onicecandidate = event => {
            ...
            if (event.candidate) {
                ...
                this.gatheredCandidates.push((0, sdp_1.parseCandidate)(event.candidate.candidate));
        ...
        return this.getLocalMediaStream(options).then(() => this.updateDirection(options, isConference, audioOnly)).then(() => this.createDataChannel(options)).then(() => {
            ...
            if (isConference && options.constraints && !options.constraints.video && !('hold' in options) && !audioOnly) {
                ...
                if ((_a = this.peerConnection) === null || _a === void 0 ? void 0 : _a.addTransceiver) {
            ...
            if (sdp.indexOf('a=candidate') !== -1) {
                return {
                    ...
                    sdp: (0, sdp_1.addIcesInAllBundles)(sdp),
                };
            }
            ...
            return {
                ...
                // @ts-ignore
                sdp: (0, sdp_1.fixSdp)(sdp, this.gatheredCandidates, options && options.constraints ? options.constraints.video : false),
            };
        })
    ...
    sendDtmf(tones, options = { duration: 0, interToneGap: 0 }) {
        if (this.isWeb) {
    ...
    close() {
        ...
        // @ts-ignore
        (_a = this.peerConnection) === null || _a === void 0 ? void 0 : _a.getLocalStreams().forEach(stream => {
        ...
        // @ts-ignore
        (_b = this.peerConnection) === null || _b === void 0 ? void 0 : _b.getRemoteStreams().forEach(stream => {
            stream.getTracks().forEach((track) => {
                track.stop();
            });
        });
            ...
            if (sender && (!sfu || newTrack.kind === 'audio')) {
                ...
                trackUpdates.push(new Promise(resolve => {
                    ...
                    if (oldTrack) {
                        ...
                        // @ts-ignore
                        session_description_handler_1.SessionDescriptionHandler.dispatchRemoveTrackEvent(localStream, oldTrack);
                    }
                    localStream.addTrack(newTrack);
                    // @ts-ignore
                    session_description_handler_1.SessionDescriptionHandler.dispatchAddTrackEvent(localStream, newTrack);
                }).catch((error) => {
    ...
    getLocalMediaStream(options) {
        ...
        let constraints = options.constraints ? Object.assign({}, options.constraints) : {};
