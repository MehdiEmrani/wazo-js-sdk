...
exports.events = exports.MESSAGE_TYPE_SIGNAL = exports.MESSAGE_TYPE_CHAT = exports.ON_EARLY_MEDIA = exports.ON_DISCONNECTED = exports.ON_SIGNAL = exports.ON_CHAT = exports.ON_NETWORK_STATS = exports.ON_MESSAGE_TRACK_UPDATED = exports.ON_CALL_ERROR = exports.ON_VIDEO_INPUT_CHANGE = exports.ON_PLAY_PROGRESS_SOUND = exports.ON_PLAY_HANGUP_SOUND = exports.ON_PLAY_INBOUND_CALL_SIGNAL_SOUND = exports.ON_PLAY_RING_SOUND = exports.ON_TERMINATE_SOUND = exports.ON_SHARE_SCREEN_ENDED = exports.ON_SHARE_SCREEN_ENDING = exports.ON_SHARE_SCREEN_STARTED = exports.ON_REMOVE_STREAM = exports.ON_VIDEO_STREAM = exports.ON_AUDIO_STREAM = exports.ON_TRACK = exports.ON_REINVITE = exports.ON_MESSAGE = exports.ON_CALL_ENDING = exports.ON_CALL_ENDED = exports.ON_CALL_REJECTED = exports.ON_CALL_FAILED = exports.ON_CALL_CANCELED = exports.ON_CAMERA_RESUMED = exports.ON_CAMERA_DISABLED = exports.ON_CALL_UNHELD = exports.ON_CALL_HELD = exports.ON_CALL_RESUMED = exports.ON_CALL_UNMUTED = exports.ON_CALL_MUTED = exports.ON_CALL_OUTGOING = exports.ON_CALL_INCOMING = exports.ON_CALL_ANSWERED = exports.ON_CALL_ACCEPTED = exports.ON_PROGRESS = exports.ON_UNREGISTERED = exports.ON_REGISTERED = exports.ON_USER_AGENT = void 0;
...
exports.ON_USER_AGENT = 'onUserAgent';
exports.ON_REGISTERED = 'onRegistered';
exports.ON_UNREGISTERED = 'onUnRegistered';
exports.ON_PROGRESS = 'onProgress';
exports.ON_CALL_ACCEPTED = 'onCallAccepted';
exports.ON_CALL_ANSWERED = 'onCallAnswered';
exports.ON_CALL_INCOMING = 'onCallIncoming';
exports.ON_CALL_OUTGOING = 'onCallOutgoing';
exports.ON_CALL_MUTED = 'onCallMuted';
exports.ON_CALL_UNMUTED = 'onCallUnmuted';
exports.ON_CALL_RESUMED = 'onCallResumed';
exports.ON_CALL_HELD = 'onCallHeld';
exports.ON_CALL_UNHELD = 'onCallUnHeld';
exports.ON_CAMERA_DISABLED = 'onCameraDisabled';
exports.ON_CAMERA_RESUMED = 'onCameraResumed';
exports.ON_CALL_CANCELED = 'onCallCanceled';
exports.ON_CALL_FAILED = 'onCallFailed';
exports.ON_CALL_REJECTED = 'onCallRejected';
exports.ON_CALL_ENDED = 'onCallEnded';
exports.ON_CALL_ENDING = 'onCallEnding';
exports.ON_MESSAGE = 'onMessage';
exports.ON_REINVITE = 'reinvite';
exports.ON_TRACK = 'onTrack';
exports.ON_AUDIO_STREAM = 'onAudioStream';
exports.ON_VIDEO_STREAM = 'onVideoStream';
exports.ON_REMOVE_STREAM = 'onRemoveStream';
exports.ON_SHARE_SCREEN_STARTED = 'onScreenShareStarted';
exports.ON_SHARE_SCREEN_ENDING = 'onScreenShareEnding';
exports.ON_SHARE_SCREEN_ENDED = 'onScreenShareEnded';
exports.ON_TERMINATE_SOUND = 'terminateSound';
exports.ON_PLAY_RING_SOUND = 'playRingingSound';
exports.ON_PLAY_INBOUND_CALL_SIGNAL_SOUND = 'playInboundCallSignalSound';
exports.ON_PLAY_HANGUP_SOUND = 'playHangupSound';
exports.ON_PLAY_PROGRESS_SOUND = 'playProgressSound';
exports.ON_VIDEO_INPUT_CHANGE = 'videoInputChange';
exports.ON_CALL_ERROR = 'onCallError';
exports.ON_MESSAGE_TRACK_UPDATED = 'onTrackUpdated';
exports.ON_NETWORK_STATS = 'onNetworkStats';
exports.ON_CHAT = 'phone/ON_CHAT';
exports.ON_SIGNAL = 'phone/ON_SIGNAL';
exports.ON_DISCONNECTED = 'onDisconnected';
exports.ON_EARLY_MEDIA = 'onEarlyMedia';
exports.MESSAGE_TYPE_CHAT = 'message/TYPE_CHAT';
exports.MESSAGE_TYPE_SIGNAL = 'message/TYPE_SIGNAL';
exports.events = [exports.ON_USER_AGENT, exports.ON_REGISTERED, exports.ON_UNREGISTERED, exports.ON_PROGRESS, exports.ON_CALL_ACCEPTED, exports.ON_CALL_ANSWERED, exports.ON_CALL_INCOMING, exports.ON_CALL_OUTGOING, exports.ON_CALL_MUTED, exports.ON_CALL_UNMUTED, exports.ON_CALL_RESUMED, exports.ON_CALL_HELD, exports.ON_CALL_UNHELD, exports.ON_CAMERA_DISABLED, exports.ON_CALL_FAILED, exports.ON_CALL_ENDED, exports.ON_CALL_REJECTED, exports.ON_MESSAGE, exports.ON_REINVITE, exports.ON_TRACK, exports.ON_AUDIO_STREAM, exports.ON_VIDEO_STREAM, exports.ON_REMOVE_STREAM, exports.ON_SHARE_SCREEN_ENDED, exports.ON_TERMINATE_SOUND, exports.ON_PLAY_RING_SOUND, exports.ON_PLAY_INBOUND_CALL_SIGNAL_SOUND, exports.ON_PLAY_HANGUP_SOUND, exports.ON_PLAY_PROGRESS_SOUND, exports.ON_VIDEO_INPUT_CHANGE, exports.ON_SHARE_SCREEN_STARTED, exports.ON_CALL_ERROR, exports.ON_CHAT, exports.ON_SIGNAL, exports.ON_NETWORK_STATS, exports.ON_DISCONNECTED, exports.ON_EARLY_MEDIA];
const logger = IssueReporter_1.default.loggerFor('webrtc-phone');
class WebRTCPhone extends Emitter_1.default {
    ...
    sendReinvite(callSession, constraints = null, conference = false, audioOnly = false, iceRestart = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const shouldScreenShare = constraints === null || constraints === void 0 ? void 0 : constraints.screen;
            const isUpgrade = shouldScreenShare || (constraints === null || constraints === void 0 ? void 0 : constraints.video);
            // Downgrade
            ...
            if (isUpgrade) {
                const shouldReinvite = yield this._upgradeToVideo(callSession, constraints, conference);
                if (!shouldReinvite) {
                    return;
                }
            }
    ...
    getUserAgent() {
        var _a, _b;
        return ((_b = (_a = this.client) === null || _a === void 0 ? void 0 : _a.config) === null || _b === void 0 ? void 0 : _b.userAgentString) || 'webrtc-phone';
    }
    startHeartbeat() {
    ...
    _upgradeToVideo(callSession, constraints, isConference) {
        return __awaiter(this, void 0, void 0, function* () {
            const sipSession = this.findSipSession(callSession);
            if (!sipSession) {
            ...
            // @ts-ignore
            const wasAudioOnly = options === null || options === void 0 ? void 0 : options.audioOnly;
            const newStream = yield this.client.upgradeToVideo(sipSession, constraints, isConference);
            if (callSession) {
    ...
    _sendReinviteMessage(callSession, isUpgrade) {
        ...
        setTimeout(() => {
            this.sendMessage(sipSession, JSON.stringify({
                type: exports.MESSAGE_TYPE_SIGNAL,
                content: {
                    type: exports.ON_MESSAGE_TRACK_UPDATED,
    ...
    _bindEvents(sipSession) {
        if (sipSession instanceof api_1.Invitation) {
            ...
            sipSession._onCancel = (message) => {
                ...
                this.eventEmitter.emit(exports.ON_CALL_CANCELED, callSession, elsewhere);
            };
        }
        ...
        sipSession.stateChange.addListener((newState) => {
            switch (newState) {
                case session_state_1.SessionState.Establishing:
                    ...
                    return this.eventEmitter.emit(exports.ON_PROGRESS, this._createCallSession(sipSession, null, {
                        incoming: false,
                        ringing: true,
                ...
                case session_state_1.SessionState.Terminating:
                    ...
                    this.eventEmitter.emit(exports.ON_CALL_ENDING, this._createCallSession(sipSession));
                    break;
                case session_state_1.SessionState.Terminated:
                    {
                        ...
                        return this.eventEmitter.emit(exports.ON_CALL_ENDED, callSession, wasCurrentSession);
                    }
                default:
                    break;
            }
        ...
        peerConnection.ontrack = (rawEvent) => {
            ...
            if (kind === 'audio') {
                return this.eventEmitter.emit(exports.ON_AUDIO_STREAM, stream);
            }
            // not sure this does anything
            if (kind === 'video') {
                event.track.enabled = false;
            }
            return this.eventEmitter.emit(exports.ON_VIDEO_STREAM, stream, event.track.id, event, sipSession);
        };
        peerConnection.onremovestream = (event) => {
            ...
            this.eventEmitter.emit(exports.ON_REMOVE_STREAM, event.stream);
        };
    }
    startScreenSharing(constraints, callSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const screenShareStream = yield this.client.getStreamFromConstraints(constraints);
    ...
    stopScreenSharing(restoreLocalStream = true, callSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (restoreLocalStream) {
                    ...
                    reinvited = yield this.sendReinvite(targetCallSession, constraints, conference);
                }
            }
            catch (e) {
                console.warn(e);
            ...
            const sipSession = this.currentSipSession;
            this.eventEmitter.emit(exports.ON_SHARE_SCREEN_ENDED, callSession && sipSession ? this._createCallSession(sipSession, callSession, {
                screensharing: false,
            }) : null);
    ...
    _onScreenSharing(screenStream, sipSession, callSession, hadVideo, desktop) {
        ...
        if (screenTrack) {
            screenTrack.onended = () => {
                ...
                this.eventEmitter.emit(exports.ON_SHARE_SCREEN_ENDING, this._createCallSession(sipSession, callSession));
            };
        }
        ...
        this.eventEmitter.emit(exports.ON_SHARE_SCREEN_STARTED, this._createCallSession(sipSession, callSession, {
            screensharing: true,
        }), screenStream);
    }
    _onCallAccepted(sipSession, cameraEnabled) {
        ...
        this.eventEmitter.emit(exports.ON_TERMINATE_SOUND, callSession, 'call accepted');
        const sipSessionId = this.getSipSessionId(sipSession);
        if (sipSessionId) {
        ...
        this._updateCallSession(callSession);
        this.eventEmitter.emit(exports.ON_CALL_ACCEPTED, callSession, cameraEnabled);
        return callSession;
    }
    ...
    _onCallTerminated(sipSession) {
        ...
        if (isCurrentIncomingCall) {
            setTimeout(() => {
                ...
                this.eventEmitter.emit(exports.ON_TERMINATE_SOUND, callSession, 'call terminated');
            }, 5);
        }
        if (sipSessionId) {
            this.removeIncomingSessions(sipSessionId);
            ...
            setTimeout(() => {
                if (this.ringingEnabled) {
                    if (!this.currentCallSession) {
                        this.eventEmitter.emit(exports.ON_PLAY_RING_SOUND, this.audioRingDeviceId, this.audioRingVolume, nextCallSession);
                    }
                    else {
                        this.eventEmitter.emit(exports.ON_PLAY_INBOUND_CALL_SIGNAL_SOUND, this.audioOutputDeviceId, this.audioOutputVolume, nextCallSession);
                    }
                }
                this.eventEmitter.emit(exports.ON_CALL_INCOMING, nextCallSession, nextCallSession === null || nextCallSession === void 0 ? void 0 : nextCallSession.cameraEnabled);
            }, 100);
        }
        ...
        if (!sipSession.isCanceled) {
            setTimeout(() => {
                this.eventEmitter.emit(exports.ON_PLAY_HANGUP_SOUND, this.audioOutputDeviceId, this.audioOutputVolume, callSession);
            }, 10);
        }
    ...
    accept(callSession, cameraEnabled) {
        ...
        this.eventEmitter.emit(exports.ON_CALL_ANSWERED, callSession);
        const sipSession = this.client.getSipSession(callSession.getId());
        if (sipSession) {
            if (sipSession.state === session_state_1.SessionState.Terminated || sipSession.state === session_state_1.SessionState.Terminating) {
        ...
        if (callSession) {
            this.eventEmitter.emit(exports.ON_CALL_ERROR, new Error(error), callSession);
        }
        return Promise.resolve(null);
    }
    ...
    reject(callSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.eventEmitter.emit(exports.ON_TERMINATE_SOUND, callSession, 'call rejected locally');
    ...
    ignore(callSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // kill the ring
            this.eventEmitter.emit(exports.ON_TERMINATE_SOUND, callSession, 'ignoring call');
    ...
    holdSipSession(sipSession, callSession, withEvent = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!sipSession) {
            ...
            if (this.currentScreenShare && this.currentScreenShare.sipSessionId === sessionId) {
                ...
                yield this.stopScreenSharing(false, callSession);
            }
            // Downgrade to audio if needed
            if (hasVideo) {
                yield this.client.downgradeToAudio(sipSession);
            }
            const isConference = !!callSession && callSession.isConference();
            const promise = this.client.hold(sipSession, isConference, hasVideo);
            if (withEvent) {
                this.eventEmitter.emit(exports.ON_CALL_HELD, this._createCallSession(sipSession, callSession));
            }
            return promise;
        });
    }
    unholdSipSession(sipSession, callSession, withEvent = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!sipSession) {
            ...
            if (hasVideo) {
                ...
                yield this.client.upgradeToVideo(sipSession, constraints, isConference);
            }
            ...
            if (withEvent) {
                ...
                // Deprecated event
                this.eventEmitter.emit(exports.ON_CALL_UNHELD, updatedCallSession);
                this.eventEmitter.emit(exports.ON_CALL_RESUMED, updatedCallSession);
            }
            return promise.then(() => {
    ...
    mute(callSession, withEvent = true) {
        ...
        if (withEvent) {
            this.eventEmitter.emit(exports.ON_CALL_MUTED, newCallSession);
        }
    }
    unmute(callSession, withEvent = true) {
        ...
        if (withEvent) {
            this.eventEmitter.emit(exports.ON_CALL_UNMUTED, newCallSession);
        }
    }
    ...
    turnCameraOn(callSession) {
        ...
        this.eventEmitter.emit(exports.ON_CAMERA_RESUMED, this._createCameraResumedCallSession(sipSession, callSession));
    }
    turnCameraOff(callSession) {
        ...
        this.eventEmitter.emit(exports.ON_CAMERA_DISABLED, this._createCameraDisabledCallSession(sipSession, callSession));
    }
    ...
    makeCall(number, line, cameraEnabled, audioOnly = false, conference = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._updateCallSession(callSession);
            this.eventEmitter.emit(exports.ON_PLAY_PROGRESS_SOUND, this.audioOutputDeviceId, this.audioOutputVolume);
            this.currentSipSession = sipSession;
            this.currentCallSession = callSession;
            this.eventEmitter.emit(exports.ON_CALL_OUTGOING, callSession);
            ...
            if (sipSession.invitePromise) {
                ...
                sipSession.invitePromise.catch(error => {
                    this.eventEmitter.emit(exports.ON_CALL_ERROR, error, callSession);
                });
            }
    ...
    hangup(callSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sipSessionId = this.getSipSessionId(sipSession);
            yield this.client.hangup(sipSession);
            if (callSession) {
    ...
    endCurrentCall(callSession) {
        ...
        this.eventEmitter.emit(exports.ON_TERMINATE_SOUND, callSession, 'locally ended');
    }
    onConnectionMade() { }
    ...
    close(force = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield Promise.race([this.unregister(), new Promise((resolve, reject) => setTimeout(() => reject(new Error('Unregister, timed out')), 3000))]);
            }
            catch (e) {
    ...
    bindClientEvents() {
        ...
        this.client.on(this.client.INVITE, (sipSession, wantsToDoVideo) => {
            ...
            if (!this.currentSipSession) {
                if (this.ringingEnabled) {
                    this.eventEmitter.emit(exports.ON_PLAY_RING_SOUND, this.audioRingDeviceId, this.audioRingVolume, callSession);
                }
            }
            else {
                this.eventEmitter.emit(exports.ON_PLAY_INBOUND_CALL_SIGNAL_SOUND, this.audioOutputDeviceId, this.audioOutputVolume, callSession);
            }
            callSession.creationTime = new Date();
            this._updateCallSession(callSession);
            this.eventEmitter.emit(exports.ON_CALL_INCOMING, callSession, wantsToDoVideo);
        });
        ...
        this.client.on(this.client.ON_ERROR, e => {
            ...
            this.eventEmitter.emit(exports.ON_CALL_ERROR, e);
        });
        ...
        this.client.on(this.client.REGISTERED, () => {
            ...
            this.stopHeartbeat();
            this.eventEmitter.emit(exports.ON_REGISTERED);
            ...
            if (this.shouldSendReinvite && this.currentSipSession && this.currentSipSession.state === session_state_1.SessionState.Established) {
                this.shouldSendReinvite = false;
                // @ts-ignore
                const pc = (_b = (_a = this.currentSipSession) === null || _a === void 0 ? void 0 : _a.sessionDescriptionHandler) === null || _b === void 0 ? void 0 : _b.peerConnection;
        ...
        this.client.on(this.client.ON_TRACK, (session, event) => {
            this.eventEmitter.emit(exports.ON_TRACK, session, event);
        });
        this.client.on('onVideoInputChange', stream => {
            this.eventEmitter.emit(exports.ON_VIDEO_INPUT_CHANGE, stream);
        });
        this.client.on(this.client.MESSAGE, (message) => {
            this._onMessage(message);
            this.eventEmitter.emit(exports.ON_MESSAGE, message);
        });
        this.client.on(this.client.ON_NETWORK_STATS, (session, stats, previousStats) => {
            ...
            this.eventEmitter.emit(exports.ON_NETWORK_STATS, callSession, stats, previousStats);
        });
        ...
        this.client.on(this.client.ON_SCREEN_SHARING_REINVITE, (sipSession, response, desktop) => {
            ...
            logger.info('Updrading directly in screensharing mode', {
                sipSessionId,
                tracks: (localStream === null || localStream === void 0 ? void 0 : localStream.getTracks()) || null,
            });
    ...
    _onMessage(message) {
        ...
        switch (type) {
            case exports.MESSAGE_TYPE_CHAT:
                this.eventEmitter.emit(exports.ON_CHAT, content);
                break;
            case exports.MESSAGE_TYPE_SIGNAL:
                {
                    this.eventEmitter.emit(exports.ON_SIGNAL, content);
                    break;
                }
            default:
        }
    ...
    _createCallSession(sipSession, fromSession, extra = {}) {
        ...
        const callSession = new CallSession_1.default(Object.assign({ callId: fromSession && fromSession.callId, sipCallId: sessionId, sipStatus: state, displayName: identity ? identity.displayName || number : number, 
            // @ts-ignore: @HEADSUP: startTime should be a number, not a date
            startTime: fromSession ? fromSession.startTime : new Date(), creationTime: fromSession ? fromSession.creationTime : null, answerTime: fromSession ? fromSession.answerTime : null, endTime: fromSession ? fromSession.endTime : null, answered: state === session_state_1.SessionState.Established, paused: this.client.isCallHeld(sipSession), isCaller: fromSession ? fromSession.isCaller : 'incoming' in extra ? !extra.incoming : false, cameraEnabled: fromSession ? fromSession.isCameraEnabled() : this.client.hasVideo(sessionId), number, ringing: false, muted: fromSession ? fromSession.isMuted() : this.client.isAudioMuted(sipSession), videoMuted: fromSession ? fromSession.isVideoMuted() : false, recording: fromSession ? fromSession.isRecording() : false, recordingPaused: false, sipSession, conference: !!fromSession && fromSession.isConference() }, extra));
