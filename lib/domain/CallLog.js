...
class CallLog {
    ...
    static parse(plain) {
        return new CallLog({
            answer: plain.answer ? (0, moment_1.default)(plain.answer).toDate() : null,
            ...
            start: (0, moment_1.default)(plain.start).toDate(),
            end: plain.end ? (0, moment_1.default)(plain.end).toDate() : null,
            recordings: Recording_1.default.parseMany(plain.recordings || []),
        });
    }
    ...
    static newFrom(profile) {
        return (0, new_from_1.default)(profile, CallLog);
    }
