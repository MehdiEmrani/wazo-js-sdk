...
describe('Meeting domain', () => {
    it('should retain its values when parsed', () => {
        ...
        const meeting = Meeting_1.default.parse(args);
        const { uri, uuid, name, port, extension, persistent, ownerUuids, creationTime, requireAuthorization, } = meeting;
        ...
        expect(creationTime).toEqual((0, moment_1.default)(rawCreationTime).toDate());
    ...
    it('should retain its values when instantiated', () => {
        ...
        const meeting = new Meeting_1.default(args);
    ...
    it('should return a date from a string', () => {
        ...
        const { creationTime, } = Meeting_1.default.parse(args);
