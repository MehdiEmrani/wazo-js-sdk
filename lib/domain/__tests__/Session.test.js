...
describe('Session domain', () => {
    it('can parse a plain session to domain', () => {
        ...
        const session = Session_1.default.parse(plain);
        expect(session).toEqual(new Session_1.default({
            token: 'b93ae6bd-08d7-4001-9e61-057e72bbc4b3',
            refreshToken: null,
            acl: ['calld.lines.*.presences.read', 'calld.switchboards.#', 'calld.transfers.*.complete.update', 'calld.transfers.*.delete', 'calld.transfers.*.read', 'calld.users.*.presences.read', 'calld.users.me.#', 'confd.infos.read', 'confd.users.me.#.read', 'confd.users.me.forwards.*.*', 'confd.users.me.funckeys.*', 'confd.users.me.funckeys.*.*', 'confd.users.me.read', 'confd.users.me.services.*.*', 'confd.users.me.update', 'dird.#.me.read', 'dird.directories.favorites.#', 'dird.directories.lookup.*.headers.read', 'dird.directories.lookup.*.read', 'dird.directories.personal.*.read', 'dird.personal.#', 'events.calls.me', 'events.chat.message.*.me', 'events.config.users.me.#', 'events.statuses.*', 'events.switchboards.#', 'events.transfers.me', 'events.users.me.#', 'events.directory.me.#', 'websocketd', 'call-logd.users.me.cdr.read'],
            uuid: 'a14dd6d6-547c-434d-bd5c-e882b5b83b54',
    ...
    describe('when getting the primary context', () => {
        ...
        let A_SESSION;
        beforeEach(() => {
            A_SESSION = new Session_1.default({
                token: 'ref-12345',
                uuid: '1234',
                expiresAt: new Date(9999, 0, 1),
                engineVersion: null,
        ...
        describe('given NO engine version', () => {
            beforeEach(() => {
                A_SESSION = new Session_1.default(Object.assign(Object.assign({}, A_SESSION), { engineVersion: null }));
            });
            describe('and NO profile', () => {
                beforeEach(() => {
                    A_SESSION = new Session_1.default(Object.assign(Object.assign({}, A_SESSION), { profile: null }));
                });
                it('should return default context', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            describe('and NO lines', () => {
                beforeEach(() => {
                    A_SESSION = new Session_1.default(Object.assign(Object.assign({}, A_SESSION), { 
                        // @ts-expect-error
                        profile: new Profile_1.default({
                            lines: [],
                        }) }));
            ...
            describe('and some lines', () => {
                beforeEach(() => {
                    ...
                    A_SESSION = new Session_1.default(Object.assign(Object.assign({}, A_SESSION), { profile }));
                });
                it('should return line context', () => __awaiter(void 0, void 0, void 0, function* () {
                    const context = A_SESSION.primaryContext();
        ...
        describe('given an engine version', () => {
            describe('that is invalid', () => {
                beforeEach(() => {
                    A_SESSION = new Session_1.default(Object.assign(Object.assign({}, A_SESSION), { engineVersion: '19.09' }));
                });
                describe('and NO lines', () => {
                    beforeEach(() => {
                        // @ts-expect-error
                ...
                describe('and some lines', () => {
                    beforeEach(() => {
                        ...
                        A_SESSION = new Session_1.default(Object.assign(Object.assign({}, A_SESSION), { profile, engineVersion: '18.08' }));
                    });
                    it('should return line context', () => __awaiter(void 0, void 0, void 0, function* () {
                        const context = A_SESSION.primaryContext();
                        expect(context).toEqual(SOME_CONTEXT);
            ...
            describe('when version is 19.10', () => {
                it('should not consider that version is 19.1', () => {
                    A_SESSION = new Session_1.default(Object.assign(Object.assign({}, A_SESSION), { engineVersion: '19.10' }));
