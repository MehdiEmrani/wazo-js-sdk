...
const Voicemail_1 = __importDefault(require("../Voicemail"));
const defaultCaller = {
    name: 'john doe',
    number: '0101010101',
};
describe('Voicemail', () => {
    it('is the same voicemail given the same id', () => {
        const voicemail = new Voicemail_1.default({
            id: 'ref-abc',
            caller: defaultCaller,
            date: new Date(),
            duration: 0,
        });
        const anotherVoicemail = new Voicemail_1.default({
            id: 'ref-abc',
            caller: defaultCaller,
            date: new Date(),
            duration: 0,
    ...
    describe('when parsing', () => {
        it('can convert the date to unix timestamp', () => {
            ...
            const voicemail = Voicemail_1.default.parse(raw);
