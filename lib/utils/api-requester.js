...
class ApiRequester {
    ...
    static base64Encode(str) {
        return typeof btoa !== 'undefined' ? btoa(str) : js_base64_1.Base64.encode(str);
    }
    ...
    call(path, method = 'get', body = null, headers = null, parse = ApiRequester.defaultParser, firstCall = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const options = Object.assign({ method, body: newBody, headers: Object.assign(Object.assign({}, this.getHeaders(headers)), extraHeaders), agent: this.agent }, fetchOptions);
            ...
            return (0, exports.realFetch)()(url, options).then((response) => {
                const contentType = response.headers.get('content-type') || '';
                const isJson = contentType.indexOf('application/json') !== -1;
                IssueReporter_1.default.logRequest(url, options, response, start);
                ...
                if ((isHead && response.status >= 500) || (!isHead && response.status >= 400)) {
                    ...
                    const exceptionClass = response.status >= 500 ? ServerError_1.default : BadResponse_1.default;
                    return promise.then((err) => __awaiter(this, void 0, void 0, function* () {
    ...
    _replayWithNewToken(err, path, method, body = null, headers = null, parse) {
        ...
        return (_a = this.refreshTokenPromise) === null || _a === void 0 ? void 0 : _a.then(() => {
            this.refreshTokenPromise = null;
    ...
    getHeaders(header) {
        ...
        return Object.assign(Object.assign({ 'X-Auth-Token': this.token }, (this.tenant ? {
            'Wazo-Tenant': this.tenant,
        } : null)), { Accept: 'application/json', 'Content-Type': 'application/json' });
    }
